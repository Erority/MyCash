...
import com.example.mycash.databinding.FragmentIncomesBinding;
...
import com.example.mycash.viewmodel.IncomesViewModel;
...
public class IncomesFragment extends Fragment implements HistoryAdapterItemClickListener {
    ...
    public static final int DELETE_HISTORY = 3;
        ...
        public IncomesFragment(UpdateViewFromFragment updateViewFromFragment) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            viewModel = new ViewModelProvider(getActivity()).get(IncomesViewModel.class);
        ...
        private void setListeners(){
            binding.buttonAddIncomes.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(getContext(), AddOperationActivity.class);
                    intent.putExtra("isIncomes", true);
