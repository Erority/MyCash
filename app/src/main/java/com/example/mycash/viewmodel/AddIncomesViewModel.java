...
public class AddIncomesViewModel extends ViewModel {

    private OperationCategoryService operationCategoryService = new OperationCategoryService(false);
